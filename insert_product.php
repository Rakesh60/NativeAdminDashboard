...
if (isset($_POST['insert_product'])) {
    ...
    if ($product_title == '' or $description == '' or $product_keyword == '' or $product_categories == '' or $product_state == '' or $product_price == '' or $product_image1 == '' or $product_image2 == '' or $product_image3 == '') {
        ...
        $insert_product = "INSERT INTO `products`(product_title,product_description,product_keyword,category_id,state_id,product_image1,product_image2,product_image3,product_price,date,status) VALUES(' $product_title','$description','$product_keyword','$product_categories','$product_state','$product_image1','$product_image2','$product_image3','$product_price',NOW(),'$product_status')";
...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,200;0,400;0,800;1,100;1,200&display=swap" />
</head>
        ...
        <form action="insert_product.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" name="product_title" id="product_title" class="form-control "
                    placeholder="Enter Your Product Title" autocomplete="off" required="required">
            </div>
            <!-- DESCRIPTION -->
            <div class="form-outline mb-4 w-50 m-auto">
                <label for="description" class="form-label">Product Description</label>
                <input type="text" name="description" id="description" class="form-control"
                    placeholder="Enter Your Product product description" autocomplete="off" required="required">
            </div>
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" name="product_keyword" id="product_keyword" class="form-control"
                    placeholder="Enter Your Product product Keywords" autocomplete="off" required="required">
            </div>
            <!-- PRODUCT CATEGORY -->
            <div class="form-outline mb-4 w-50 m-auto">
...
?>
            ...
            <!-- PRODUCT STATE -->
            <div class="form-outline mb-4 w-50 m-auto">
                <select name="product_state" id="" class="product_category form-select">
...
while ($row = mysqli_fetch_assoc($result_query)) {
    ...
    echo " <option class='optiopn' value='$state_id'>$state_title</option>";
}
...
?>
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" name="product_price" id="product_price" class="form-control"
                    placeholder="Enter Your Product product price" autocomplete="off" required="required">
            </div>
