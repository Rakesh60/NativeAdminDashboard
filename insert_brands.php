...
//select data from databse
    ...
    <strong>Brand $state_title Insereted</strong> Your Brand Has been Inserted Successfully
...
<form action=" " method="post">
    <div class="input-group w-90 mb-3">
        ...
        <input type="text" class="form-control" placeholder="Insert your brand name" name="state_title">
    </div>
